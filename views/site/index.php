    ...
    <div class="panel" id="step1Panel">
            ...
            <div class="tour-selection-wrap">
                ...
                <div class="tour-selection-wrap-in">
                    <div class="bth__ta-resizable-wrap">
                        <div class="bth__ta-resizable order-wish" contenteditable=""></div>
        ...
        <div class="order-form__step-2">
            <div class="tour-selection-wrap">
                <div class="tour-selection-wrap-in mt0 tour-selection-wrap-flex">
                    <div class="tour-selection-field tour-selection-field--270">
                        <div class="js-add-error bth__inp-block  ">
                            <input type="text" value="" class="bth__inp js-label" id="name3">
                    ...
                    <div class="tour-selection-field tour-selection-field--270">
                        <div class="js-add-error bth__inp-block ">
                            <input value="" type="text" class="bth__inp js-label" id="phone3"
                                   placeholder="">
                    ...
                    <div class="tour-selection-field tour-selection-field--270">
                        <div class="bth__inp-block  ">
                            <input type="text" value="" class="bth__inp js-label " id="mail2">
                    ...
                    <div class="tour-selection-field tour-selection-field--270 ">
                        ...
                        <div class="formDirections w100p">
                            <div class="formDirections__wrap w100p">
                                ...
                                <div class="SumoSelect formDirections__SumoSelect formDirections__SumoSelect-search">
                                    <select id="sumo-list-city"></select>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tour-selection-wrap-in ">
                    <a href="#" class="metro-valid-pp bth__btn  bth__btn--fill bth__loader" data-submit-step="2">
                        Отправить запрос*
                        <div class=" bth__loader-spin">
                            <i class="fas fa-circle"></i>
                            <i class="fas fa-circle"></i>
