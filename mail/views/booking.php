                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td style="font-family:Arial,sans-serif;font-size: 12px;line-height: 16px;color: #999999;text-align: center;padding: 30px 5px;">
                                    Это письмо отправлено на адрес <?=$emailTo?> автоматически. При возникновении
                                    вопросов вы можете обратиться в <a href="<?=$supportLink?>" target="_blank">техподдержку TopHotels</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
